...
>
> El objetivo es que **un Mac acceda al servidor de Boochan igual que los otros dos clientes**, y vea lo mismo. Si lo consigues, has demostrado que el modelo de permisos **no depende del sistema del cliente**.

> [!important] 2. Acceso SMB — no es lo mismo que unirse
> En las Fases 8 y 9, el cliente se **unió al dominio** (se le creó una cuenta de equipo). En esta, el Mac **accede** a las carpetas con un usuario del dominio, pero **no se une**.
>
> **La analogía:** una empresa tiene un servidor de archivos. Los empleados fijos tienen **cuenta de equipo** (se unen). Un visitante o un portátil ajeno **entra con su usuario y contraseña** cuando necesita un archivo — sin instalarse nada, sin pertenecer. Eso es lo que hace el Mac.
>
...
> [!warning] 3. Los dos servicios que necesita (y que ya montaste)
...
> [!warning] 4. El fallo nº1: **la hora del Mac**
...
> [!important] 5. El comando clave — `smb://`
...
> [!info] 6. Quién ve qué — la matriz, una vez más
