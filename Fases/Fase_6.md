...
>
> **📦 Entrega:** una entrada de apuntes + un vídeo + la instantánea `Fase 6 terminada`
...
| **8** | [[Fase_6.8_Punto_de_Control]] | Al terminar, con la grabación aún en marcha |
| **9** | [[Fase_6.9_Preguntas]] | Después de la instantánea — trabajo de mesa |
| **10** | [[Fase_6.10_Auditoria_y_Cierre]] | Lo último — la checklist antes de seguir |
...
**Siguiente al terminar los diez apartados:** Fase 7.
