...
- **Tu entrada ya debería estar abierta** desde el índice de la fase (`b2-f5-gestion-de-identidades.md`). Repasa lo que llevas escrito **antes** de grabar: es lo que te evita improvisar delante del micrófono.
