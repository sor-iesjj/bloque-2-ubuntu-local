...
> 7. **Primer login:** Iniciar sesión con `BOOCHANLAB\masao.sato` y su contraseña desde la pantalla de inicio
> 8. **Instalar RSAT:** Herramientas administrativas para gestionar usuarios/grupos desde Windows gráficamente
> 9. **Mapear carpetas de red:** Conectar `\\UbuntuServer.BOOCHANLAB.LOCAL\comercial` y `facturacion` como unidades de red (Z:, por ejemplo)
>
...
| :--- | :---: | ---: |
| [[Fase_8.3_Obligaciones_Grabacion]] | [[Fase_8_Integracion_del_Cliente_Windows_11]] | [[Fase_8.5_Fundamento_Teorico]] |
