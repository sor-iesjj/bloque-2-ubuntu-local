## Fase 8 · Apartado 3 — 📹 Obligaciones de grabación
...
> 1. **Prepárate primero (sin grabar):** comprueba lo necesario, **léete el procedimiento entero** y **crea la entrada de apuntes de esta fase** en Obsidian: fichero `b2-8-integracion-del-cliente.md` dentro de `00_Apuntes/Trimestre_N/B2_Ubuntu_Local/`, con la estructura del **Bloque 0 · Fase 0.1.b** y **vacía**. Rellenarla es cosa tuya, después.
> 2. **Arranca OBS y PRESÉNTATE:** *"Hola, me llamo [Nombre], 2.º SMR, y en este vídeo voy a explicar la Fase 8 del Bloque 2 — Integración del Cliente (Windows 11)."* Y **muestra algo que demuestre que eres tú** (tu perfil de GitHub, tu Teams o tu correo `@alu.edu.gva.es`). Di qué vas a hacer.
...
> 5. **Al terminar:** nombra el vídeo `B2 · F8 · Integración del cliente`, súbelo a tu playlist de YouTube **`B2_Ubuntu_Local`** (No listado) y **copia su enlace**.
...
> 7. **El enlace del vídeo va DENTRO de tu entrada de apuntes**, en el apartado `🔗 Enlaces`. Ahí, no en un papel.
...
> [!info] 🏷️ Por qué los vídeos se llaman `B2 · F8 · …`
> `B2` es el **bloque** y `F8` la **fase**. Es el mismo formato que usan el Bloque 1 (`B1.5 · …`) y el Bloque 6 (`B6.1.1 · …`).

> [!tip] 💡 ¿Y si la fase te ha llevado tres clases?
> **Una fase, una entrada.** No creas un fichero por día: abres el mismo y sigues escribiendo. Haz `commit` y `push` **al terminar cada sesión**.

---

| ← Anterior | 🧭 Índice | Siguiente → |
| :--- | :---: | ---: |
| [[Fase_8.2_Entregables]] | [[Fase_8_Integracion_del_Cliente_Windows_11]] | [[Fase_8.4_Donde_Estamos]] |
