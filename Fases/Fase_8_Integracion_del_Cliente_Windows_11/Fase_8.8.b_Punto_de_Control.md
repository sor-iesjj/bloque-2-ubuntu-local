...
- [ ] 💿 **`B2-F8-servidor.ova`** y **`B2-F8-cliente-windows.ova`** en `SOR/Bloque_2/Fases/Fase_8_Integracion_del_Cliente_Windows_11/`.
- [ ] Tamaños comprobados.
...
| :--- | :---: | ---: |
| [[Fase_8.8.a_Verificacion]] | [[Fase_8_Integracion_del_Cliente_Windows_11]] | [[Fase_8.9_Preguntas]] |
