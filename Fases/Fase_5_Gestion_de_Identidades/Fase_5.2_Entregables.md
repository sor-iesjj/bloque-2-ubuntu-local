## Fase 5 · Apartado 2 — ✅ Qué tienes que entregar
...
> | **💿 Copia de seguridad** | Tu disco externo | `SOR/Bloque_2/Fases/Fase_5_Gestion_de_Identidades/B2-F5-gestion-de-identidades.ova` |

> [!important] 🎬 Los tres vídeos, y por qué son tres
> | # | Nombre exacto | Qué se ve |
> | :--- | :--- | :--- |
> | 1 | `B2 · F5 · Gestión de identidades` | El procedimiento: nsswitch, grupos, usuarios y la comprobación con `id` |
> | 2 | `B2 · F5 · Punto de control` | El apagado, la instantánea y la exportación a `.ova` |
> | 3 | `B2 · F5 · Laboratorio de averías` | Las seis averías provocadas y reparadas, con un timestamp cada una |
>
...
| :--- | :---: | ---: |
| [[Fase_5.1_Que_Se_Evalua]] | [[Fase_5_Gestion_de_Identidades]] | [[Fase_5.3_Obligaciones_Grabacion]] |
