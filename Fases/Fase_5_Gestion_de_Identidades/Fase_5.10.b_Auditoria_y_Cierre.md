...
- [ ] 💿 **`B2-F5-gestion-de-identidades.ova`** en `SOR/Bloque_2/Fases/Fase_5_Gestion_de_Identidades/` de tu **disco externo**.
...
| :--- | :---: | ---: |
| [[Fase_5.10.a_Laboratorio_de_Averias]] | [[Fase_5_Gestion_de_Identidades]] | **Fase 6** |
