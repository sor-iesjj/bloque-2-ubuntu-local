## Fase 2 · Apartado 2 — ✅ Qué tienes que entregar
...
| **Nombre exacto** | `b2-2-purga-y-preparacion.md` |
...
| | |
| :--- | :--- |
| **Nombre exacto** | `B2 · F2 · Purga y Preparación` |
| **Duración** | ~8-10 min |
| **Qué se ve** | El apartado 6 entero: purgar Samba, instalar los paquetes del dominio, actualizar y fijar la identidad |

### **3 · VÍDEO DE VERIFICACIÓN**

| | |
| :--- | :--- |
| **Nombre exacto** | `B2 · F2 · Verificación` |
| **Duración** | ~4-6 min |
...
| | |
| :--- | :--- |
| **Nombre exacto** | `B2 · F2 · Laboratorio de averías` |
| **Duración** | ~8-12 min |
| **Qué se ve** | Las cinco averías del apartado 10.a: **tu predicción en voz alta**, la rotura, la comprobación y el arreglo |
...
**Nombre del fichero de esta fase:** `B2-F2-purga-y-preparacion.ova`
...
| # | Nombre exacto |
| :--- | :--- |
| 1 | `B2 · F2 · Purga y Preparación` |
| 2 | `B2 · F2 · Verificación` |
| 3 | `B2 · F2 · Laboratorio de averías` |
...
> Abro tu repositorio, encuentro `b2-2-purga-y-preparacion.md`, y dentro está: qué has hecho, qué has entendido, qué dudas te quedaron y **los cuatro enlaces de vídeo**.
>
...
| :--- | :---: | ---: |
| [[Fase_2.1_Que_Se_Evalua]] | [[Fase_2_Purga_y_Preparacion_del_Entorno]] | [[Fase_2.3_Obligaciones_Grabacion]] |
