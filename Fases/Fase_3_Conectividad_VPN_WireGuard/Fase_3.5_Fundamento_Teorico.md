...
> 1. **Abre la entrada de apuntes** que llevas escribiendo desde el índice (`b2-3-conectividad-vpn.md`). Repasa lo que tienes: la teoría del apartado 5 la vas a necesitar ahora.
...
| :--- | :---: | ---: |
| [[Fase_3.4_Donde_Estamos]] | [[Fase_3_Conectividad_VPN_WireGuard]] | [[Fase_3.6_Procedimiento]] |
