## Fase 3 · Apartado 3 — 📹 Obligaciones de grabación
...
> | :--- | :--- | :--- | :--- |
> | 1 | `B2 · F3 · Conectividad VPN` | Apartado **6** — el procedimiento | ~8-10 min |
> | 2 | `B2 · F3 · Verificación` | Apartado **8.a** — las cinco comprobaciones | ~4-6 min |
> | 3 | `B2 · F3 · Laboratorio de averías` | Apartado **10.a** — las seis averías | ~10-15 min |
> | 4 | `B2 · F3 · Punto de control` | Apartado **8.b** — instantánea y copia al disco | ~2-3 min |
>
...
- **Tu entrada ya debería estar abierta** desde el índice de la fase (`b2-3-conectividad-vpn.md`). Repasa lo que llevas escrito **antes** de grabar: es lo que te evita improvisar delante del micrófono.

**1B — Al empezar cada vídeo: preséntate**
> *"Hola, me llamo [Nombre], 2.º SMR. En este vídeo voy a hacer la verificación de la Fase 3 del Bloque 2."*
...
**2A — Procedimiento** · `B2 · F3 · Conectividad VPN`
- Se graba **entero**, de principio a fin.
- Que se vean **los dos lados**: el servidor por SSH y la aplicación de WireGuard en Windows.

**2B — Verificación** · `B2 · F3 · Verificación`
...
**2C — Laboratorio de averías** · `B2 · F3 · Laboratorio de averías`
...
**2D — Punto de control** · `B2 · F3 · Punto de control`
...
> Si el procedimiento se te va de 15 minutos, **pártelo en dos** y llámalos `B2 · F3 · Conectividad VPN (1 de 2)` y `(2 de 2)`. Pon los dos enlaces en la entrada.
>
...
| :--- | :---: | ---: |
| [[Fase_3.2_Entregables]] | [[Fase_3_Conectividad_VPN_WireGuard]] | [[Fase_3.4_Donde_Estamos]] |
