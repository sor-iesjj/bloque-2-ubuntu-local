...
| **Nombre exacto** | `b2-3-conectividad-vpn.md` |
...
> Abro tu repositorio, encuentro `b2-3-conectividad-vpn.md`, y dentro está: qué has hecho, qué has entendido, qué dudas te quedaron y **los cuatro enlaces de vídeo**.
>
...
| :--- | :---: | ---: |
| [[Fase_3.1_Que_Se_Evalua]] | [[Fase_3_Conectividad_VPN_WireGuard]] | [[Fase_3.3_Obligaciones_Grabacion]] |
