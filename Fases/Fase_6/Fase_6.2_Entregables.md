...
> | :--- | :--- | :--- |
> | **Entrada de apuntes** | `00_Apuntes/Trimestre_N/B2_Ubuntu_Local/b2-f6-almacenamiento-virtual.md` | El procedimiento con tus palabras + **respuestas a las preguntas críticas** + **enlace del vídeo** |
> | **Vídeo** | Playlist `B2_Ubuntu_Local` (No listado) | `B2 · F6 · Almacenamiento virtual`, con presentación, identidad y timestamps |
