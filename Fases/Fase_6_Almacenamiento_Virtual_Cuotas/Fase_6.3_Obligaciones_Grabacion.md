...
- **Tu entrada ya debería estar abierta** desde el índice de la fase (`b2-6-almacenamiento-virtual.md`). Repasa lo que llevas escrito **antes** de grabar: es lo que te evita improvisar delante del micrófono.
...
| :--- | :---: | ---: |
| [[Fase_6.2_Entregables]] | [[Fase_6_Almacenamiento_Virtual_Cuotas]] | [[Fase_6.4_Donde_Estamos]] |
