...
- [ ] 💿 **`B2-F4-aprovisionamiento-del-dominio.ova`** en `SOR/Bloque_2/Fases/Fase_4_Aprovisionamiento_del_Dominio/` de tu **disco externo**.
...
| :--- | :---: | ---: |
| [[Fase_4.10.a_Laboratorio_de_Averias]] | [[Fase_4_Aprovisionamiento_del_Dominio]] | **Fase 5** |
