...
| **Nombre exacto** | `b2-f2-purga-y-preparacion.md` |
...
> Abro tu repositorio, encuentro `b2-f2-purga-y-preparacion.md`, y dentro está: qué has hecho, qué has entendido, qué dudas te quedaron y **los cuatro enlaces de vídeo**.
>
