...
- [ ] 💿 **`B2-F1-infraestructura-virtual.ova`** en `SOR/Bloque_2/Fases/Fase_1_Infraestructura_Virtual_Local/` de tu **disco externo**.
...
| :--- | :---: | ---: |
| [[Fase_1.10.a_Laboratorio_de_Averias]] | [[Fase_1_Infraestructura_Virtual_Local]] | **Fase 2** |
