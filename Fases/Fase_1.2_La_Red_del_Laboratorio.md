...
> 1. **Sin grabar:** léete el procedimiento entero y **crea vacía** la entrada `v1-fase-1-2-la-red-del-laboratorio.md`.
...
> 5. Vídeo: `V1 · Fase 1.2 — La Red del Laboratorio`, playlist **`B2_Ubuntu_Local`** (No listado). **~8-10 min.**
