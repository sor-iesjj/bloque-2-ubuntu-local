...
> 1. **Crea la entrada de apuntes** de esta fase (`v1-fase-5-gestion-de-identidades-usuarios-y-grupos.md`) con su estructura, vacía.
...
> ```
>
> En VirtualBox: selecciona la VM → **`Instantáneas`** → **`Tomar`** → nómbrala **`Fase 5 terminada`**, con la descripción *"usuarios y grupos del dominio creados"*.
>
