...
|------|--------|-------------------------------------|
| [1](Fases/Fase_1.md) | Infraestructura Virtual Local (VirtualBox) | Hipervisor Tipo 2, VM, red NAT + Red Solo Anfitrión (`vboxnet0`), IP estática |
